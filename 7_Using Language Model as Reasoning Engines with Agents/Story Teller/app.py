...
tools = [
    Tool(
        ...
        func=llm_chain.run,
        description="Use this tool for generating science finction stories. Input should be a command about generating specific types of stories."
    )
]
